...
async function sendWelcomeEmail(salon, setupUrl) {
  ...
  const subject = `Dobrodošli v FlowTek — nastavite svoje geslo`;
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#1a1a2e;border-radius:16px;overflow:hidden;border:1px solid #2a2a4a;">
        <tr><td style="background:linear-gradient(135deg,#7c3aed,#4f46e5);padding:32px 40px;text-align:center;">
          <div style="font-size:28px;font-weight:800;color:#fff;letter-spacing:-0.5px;">FlowTek</div>
        ...
        <tr><td style="padding:40px 40px 32px;">
          ...
          <p style="color:#94a3b8;font-size:15px;line-height:1.6;margin:0 0 24px;">
            Vaš FlowTek račun za <strong style="color:#e2e8f0;">${salon.name}</strong> je pripravljen.<br>
        ...
        <tr><td style="padding:20px 40px;border-top:1px solid #2a2a4a;text-align:center;">
          <p style="color:#475569;font-size:12px;margin:0;">FlowTek · noreply@flowtek.si</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
...
async function sendBookingNotification(salon, customerName, phone, date, time, ref6, sourceLabel, formAnswers = {}) {
  ...
  const subject = `Nova rezervacija - ${salon.name || 'FlowTek'}`;
  const text = [
    ...
    '',
    'Rezervacijo lahko uredite v FlowTek dashboardu.'
  ].join('\n');
...
async function sendPasswordReset(to, resetUrl) {
  return sendEmail(
    to,
    'FlowTek ponastavitev gesla',
    [
      'Pozdravljeni,',
      '',
      'Za ponastavitev FlowTek gesla odprite spodnjo povezavo:',
      resetUrl,
      '',
    ...
    <tr><td align="center">
      <table width="540" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0;">
        ...
        <tr><td style="padding:32px;">
          ...
          <p style="color:#94a3b8;font-size:12px;text-align:center;margin:20px 0 0;">Ali upravljajte rezervacije v <a href="${baseUrl}/admin.html" style="color:#7c3aed;">FlowTek dashboardu</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
